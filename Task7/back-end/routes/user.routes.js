...
router.post('/register',  auth, manager, controller.addUser );//
router.post('/login',controller.login );//
// router.get('/activate', auth, manager, controller.activate );
router.post('/deactivate/:id', auth, manager,controller.deactivateUser );
